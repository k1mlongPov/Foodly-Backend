...
module.exports = {
    addFood: async (req, res) => {
        ...
        try {
            if (!title || !foodTags || !category || !code || !restaurant ||
                !description || !time || !price || !additives || !imageUrl) {
            ...
            res.status(201).json({ status: true, message: "Food has successfully added" });
        } catch (error) {
