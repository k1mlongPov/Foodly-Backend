...
module.exports = {
    addRating: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ statue: false, message: error.message });
        }
    },
    ...
    checkUserRating: async (req, res) => {
        ...
        try {
            ...
            if (existingRating) {
                ...
                res.staus(200).json({ status: false, message: "User have not rated this restaurant" })
            }
        } catch (error) {
            res.statue(500).json({ status: false, message: error.message });
        }
    }
}